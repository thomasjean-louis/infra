        ...
        if event['routeKey'] == "GET /gamestacks":
            ...
            for items in body:
                responseItems = [
                    ...
                    # {os.environ["GAME_STACKS_ID_COLUMN_NAME"]: items[os.environ["GAME_STACKS_ID_COLUMN_NAME"]],'GAME_STACKS_SERVER_LINK_COLUMN_NAME': items['GAME_STACKS_SERVER_LINK_COLUMN_NAME']}]
